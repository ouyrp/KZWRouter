//
//  KZWItemViewControlViewController.h
//  KZWusiness
//
...
@interface KZWItemsConfig : NSObject
...
typedef void (^KZWItemsControlViewTapBlock)(NSInteger index,BOOL animation);

@interface KZWItemViewControl : UIScrollView

@property(nonatomic,strong)KZWItemsConfig *config;
@property(nonatomic,strong)NSArray *titleArray;
@property(nonatomic,assign)BOOL tapAnimation;//default is YES;
@property(nonatomic,readonly)NSInteger currentIndex;
@property(nonatomic,copy)KZWItemsControlViewTapBlock tapItemWithIndex;
